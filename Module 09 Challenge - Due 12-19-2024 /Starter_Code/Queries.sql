-- SELECT Statements to view properties of each table 
SELECT * FROM titles;
...
SELECT titles.title, dept_emp.dept_no, departments.dept_name,
dept_emp.emp_no, employees.first_name,employees.last_name
FROM dept_emp 
